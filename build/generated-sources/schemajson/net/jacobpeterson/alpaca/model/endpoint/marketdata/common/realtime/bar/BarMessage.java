    ...
    implements Serializable
{
    ...
    @Expose
    private Double vwap;
    private final static long serialVersionUID = -4649805316202961229L;
     ...
     * @param source
     */
    public BarMessage(BarMessage source) {
        super();
     ...
     * @param timestamp
     */
    public BarMessage(Double open, Double high, Double low, Double close, ZonedDateTime timestamp, Long tradeCount, Double vwap) {
        super();
        this.open = open;
        this.high = high;
        this.low = low;
    ...
    public BarMessage withOpen(Double open) {
        this.open = open;
        return this;
    }
    ...
    public BarMessage withHigh(Double high) {
        this.high = high;
        return this;
    }
    ...
    public BarMessage withLow(Double low) {
        this.low = low;
        return this;
    }
    ...
    public BarMessage withClose(Double close) {
        this.close = close;
        return this;
    }
    ...
    public BarMessage withTimestamp(ZonedDateTime timestamp) {
        this.timestamp = timestamp;
        return this;
    }
    ...
    public BarMessage withTradeCount(Long tradeCount) {
        this.tradeCount = tradeCount;
        return this;
    }
    ...
    public BarMessage withVwap(Double vwap) {
        this.vwap = vwap;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        return (((((((super.equals(rhs)&&((this.high == rhs.high)||((this.high!= null)&&this.high.equals(rhs.high))))&&((this.tradeCount == rhs.tradeCount)||((this.tradeCount!= null)&&this.tradeCount.equals(rhs.tradeCount))))&&((this.low == rhs.low)||((this.low!= null)&&this.low.equals(rhs.low))))&&((this.vwap == rhs.vwap)||((this.vwap!= null)&&this.vwap.equals(rhs.vwap))))&&((this.close == rhs.close)||((this.close!= null)&&this.close.equals(rhs.close))))&&((this.open == rhs.open)||((this.open!= null)&&this.open.equals(rhs.open))))&&((this.timestamp == rhs.timestamp)||((this.timestamp!= null)&&this.timestamp.equals(rhs.timestamp))));
    }
