    ...
    implements Serializable
{
    ...
    private final static long serialVersionUID = 2989728192746016825L;
     ...
     * @param source
     */
    public CryptoQuote(CryptoQuote source) {
        super();
     ...
     * @param askSize
     */
    public CryptoQuote(Exchange exchange, Double askSize, Double bidSize) {
        super();
    ...
    public CryptoQuote withExchange(Exchange exchange) {
        this.exchange = exchange;
        return this;
    }
    ...
    public CryptoQuote withAskSize(Double askSize) {
        this.askSize = askSize;
        return this;
    }
    ...
    public CryptoQuote withBidSize(Double bidSize) {
        this.bidSize = bidSize;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CryptoQuote.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CryptoQuote) == false) {
            return false;
        }
        CryptoQuote rhs = ((CryptoQuote) other);
