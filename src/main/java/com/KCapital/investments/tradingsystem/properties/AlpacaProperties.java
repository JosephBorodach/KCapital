package com.KCapital.investments.tradingsystem.properties;
...
import static com.KCapital.investments.tradingsystem.util.properties.PropertyUtil.getProperty;
...
public class AlpacaProperties {
     ...
     */
    public static final String KEY_ID = getProperty(ALPACA_PROPERTIES_FILE, ALPACA_DEFAULT_PROPERTIES_FILE, KEY_ID_KEY);

    private static final String SECRET_KEY_KEY = "secret_key";
    /**
     * The value of {@link #SECRET_KEY_KEY} in {@link #ALPACA_PROPERTIES_FILE}.
     */
    public static final String SECRET_KEY = getProperty(ALPACA_PROPERTIES_FILE, ALPACA_DEFAULT_PROPERTIES_FILE, SECRET_KEY_KEY);
     ...
     */
    public static final EndpointAPIType ENDPOINT_API_TYPE = EndpointAPIType.fromValue(getProperty(ALPACA_PROPERTIES_FILE, ALPACA_DEFAULT_PROPERTIES_FILE, ENDPOINT_API_TYPE_KEY));
     ...
     */
    public static final DataAPIType DATA_API_TYPE = DataAPIType.fromValue(getProperty(ALPACA_PROPERTIES_FILE, ALPACA_DEFAULT_PROPERTIES_FILE, DATA_API_TYPE_KEY));
     ...
     */
    public static final String USER_AGENT = getProperty(ALPACA_PROPERTIES_FILE, ALPACA_DEFAULT_PROPERTIES_FILE, USER_AGENT_KEY);
}
